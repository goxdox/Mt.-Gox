...
try: 
    print 'hello'
    url = 'http://127.0.0.1/wsdl/finbank2.wsdl'
    #url = 'http://mtgox.com/wsdl/finbank.wsdl'
    #url = 'http://127.0.0.1/wsdl/GoogleSearch.wsdl'
    #url= 'http://dic.googlecode.com/files/GoogleSearch.wsdl'
    #ns = 'http://schemas.xmlsoap.org/soap/encoding/'
    #location = 'http://schemas.xmlsoap.org/soap/encoding/'
    #Import.bind(ns, location)
    #imp = Import('http://schemas.xmlsoap.org/soap/encoding/', location='http://dic.googlecode.com/files/GoogleSearch.wsdl')
    print '1'
    #d = ImportDoctor(imp)
    print '2'
    client = Client(url)
